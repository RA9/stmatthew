...
<div class="content-wrapper">
	...
	?>
		...
		<div class="blogpost thumbnail">
			<img class="img-fluid  img-thumbnail" src="admin/upload/<?php echo $Image;  ?>" >
		<div class="caption">
...
<div class="CommentBlock">
	<img style="margin-left: 10px; margin-top: 10px;" class="pull-left" src="admin/images/<?php echo $CommentsImg ?>" width=70px; height=70px;>
...
while($DataRows= mysqli_fetch_assoc($Execute)){
	...
	?>
<div>
<img class="pull-left" style="margin-top: 10px; margin-left: 0px;"  src="admin/upload/<?php echo e($Image); ?>" width="120" height="60">
